  ...
  return (
    <div>
      ...
      {filteredQuestions.slice(0, numberOfQuestions).map(question => {
        return <QuestionItem question={question} key={question.question_id} handleAddAnswerClick={handleAddAnswerClick} handleClose={handleClose} />
      })}
      ...
      {showModal && (
      <Modal isAnswer='true' handleClose={handleClose} question={question} />
      )}
    </div>
  )
}
